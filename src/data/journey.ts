...
export const journeyEvents: TimelineEvent[] = [
  ...
  },
  {
    ...
    media: [
      {
        type: "image",
        src: "/projects/tutorconn/portfolio-hero.svg",
        alt: "TutorConn product overview",
        caption: "TutorConn: the early tutoring platform that started my builder journey",
        fit: "contain",
      },
      {
        type: "image",
        src: "/projects/tutorconn/login-mockup.svg",
        alt: "TutorConn product screenshot",
        caption: "Login and onboarding for students and tutors",
        fit: "contain",
      },
      {
        type: "image",
        src: "/projects/tutorconn/tutor-discovery-mockup.svg",
        alt: "TutorConn tutor discovery screen",
        caption: "Tutor discovery focused on access and academic support",
        fit: "contain",
      },
    ],
    icon: Code2,
  ...
  },
  {
    ...
    media: [
      {
        type: "image",
        src: "/projects/basafy/portfolio-hero.svg",
        alt: "Basafy product overview",
        caption: "Basafy: turning scattered job-search activity into one organized product",
        fit: "contain",
      },
      {
        type: "image",
        src: "/projects/basafy/dashboard-phone.svg",
        alt: "Basafy dashboard mobile screen",
        caption: "A clearer dashboard for applications, reminders, and next steps",
        fit: "contain",
      },
    ],
    icon: Rocket,
